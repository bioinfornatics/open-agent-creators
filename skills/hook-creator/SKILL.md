...
- Use `plugin-creator` to assemble, validate, install, or package the complete plugin.
- Use `skill-creator` for standalone or plugin-bundled Agent Skills.
- Use `agent-creator` for standalone `.agents/agents` definitions.
